  ...
  return (
    <div className="grid grid-cols-1 gap-8 lg:grid-cols-12">
          ...
          <form action={handleSubmit} className="space-y-6">
            ...
            <div>
              ...
              <input
                ...
                className="mt-2 block w-full rounded-xl border border-slate-200 bg-white px-4 py-2.5 text-sm text-slate-900 placeholder:text-slate-400 focus:border-indigo-500 focus:outline-none focus:ring-2 focus:ring-indigo-500/20 dark:border-slate-800 dark:bg-slate-950 dark:text-slate-100"
              />
            </div>
                ...
                <div className="mt-2 flex flex-wrap gap-1.5">
                  {PRESET_NAMES.map((preset) => (
                    <button
                      ...
                      className="rounded-lg border border-slate-200 bg-slate-50 px-2.5 py-1 text-xs text-slate-600 transition-colors hover:border-indigo-300 hover:bg-indigo-50 hover:text-indigo-600 dark:border-slate-800 dark:bg-slate-800 dark:text-slate-300 dark:hover:border-indigo-700 dark:hover:bg-indigo-950/40"
                    >
                      + {preset}
                    </button>
                  ))}
            ...
            <div className="flex items-center gap-3 pt-2">
              <button
                ...
                className="inline-flex items-center gap-2 rounded-xl bg-indigo-600 px-5 py-2.5 text-sm font-semibold text-white shadow-md shadow-indigo-600/20 transition-all hover:bg-indigo-500 disabled:opacity-50"
              >
                {isSubmitting ? (
                  <span>Saving...</span>
                ) : (
      ...
      <div className="lg:col-span-5">
        <div className="rounded-3xl border border-slate-200/80 bg-slate-100/60 p-6 dark:border-slate-800 dark:bg-slate-900/40">
